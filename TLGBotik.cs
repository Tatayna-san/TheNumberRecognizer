    ...
    class TLGBotik
    {
        ...
        private async Task HandleUpdateMessageAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            if (message.Type == Telegram.Bot.Types.Enums.MessageType.Photo)
            {
                ...
                {
                    case FigureType.zero: await AnswerText(chatId, username, "Загадываю 0"); break;
                    case FigureType.one: await AnswerText(chatId, username, "Загадываю 1"); break;
                    case FigureType.two: await AnswerText(chatId, username, "Загадываю 2"); break;
                    case FigureType.three: await AnswerText(chatId, username, "Загадываю 3"); break;
                    case FigureType.four: await AnswerText(chatId, username, "Загадываю 4"); break;
                    case FigureType.five: await AnswerText(chatId, username, "Загадываю 5"); break;
                    case FigureType.six: await AnswerText(chatId, username, "Загадываю 6"); break;
                    case FigureType.seven: await AnswerText(chatId, username, "Загадываю 7"); break;
                    case FigureType.eight: await AnswerText(chatId, username, "Загадываю 8"); break;
                    case FigureType.nine: await AnswerText(chatId, username, "Загадываю 9"); break;
